...
namespace System
{
    ...
    ITuple
  {
    ...
    private int CompareTo(object other, IComparer comparer)
    {
      ...
      return num6 != 0 ? num6 : comparer.Compare((object) this.m_Item7, (object) tuple.m_Item7);
    }
