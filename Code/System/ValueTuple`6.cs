...
namespace System
{
    ...
    ITuple
  {
    ...
    public override bool Equals([NotNullWhen(true)] object? obj) => obj is (T1, T2, T3, T4, T5, T6) other && this.Equals(other);
    ...
    public bool Equals((T1, T2, T3, T4, T5, T6) other) => EqualityComparer<T1>.Default.Equals(this.Item1, other.Item1) && EqualityComparer<T2>.Default.Equals(this.Item2, other.Item2) && EqualityComparer<T3>.Default.Equals(this.Item3, other.Item3) && EqualityComparer<T4>.Default.Equals(this.Item4, other.Item4) && EqualityComparer<T5>.Default.Equals(this.Item5, other.Item5) && EqualityComparer<T6>.Default.Equals(this.Item6, other.Item6);
    ...
    bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer) => other is (T1, T2, T3, T4, T5, T6) valueTuple && comparer.Equals((object) this.Item1, (object) valueTuple.Item1) && comparer.Equals((object) this.Item2, (object) valueTuple.Item2) && comparer.Equals((object) this.Item3, (object) valueTuple.Item3) && comparer.Equals((object) this.Item5, (object) valueTuple.Item5) && comparer.Equals((object) this.Item6, (object) valueTuple.Item6);
    ...
    int IComparable.CompareTo(object other)
    {
      if (other != null)
      {
        if (other is (T1, T2, T3, T4, T5, T6) other1)
    ...
    public int CompareTo((T1, T2, T3, T4, T5, T6) other)
    {
      ...
      return num5 != 0 ? num5 : Comparer<T6>.Default.Compare(this.Item6, other.Item6);
    }
    ...
    int IStructuralComparable.CompareTo(object other, IComparer comparer)
    {
      if (other != null)
      {
        if (other is (T1, T2, T3, T4, T5, T6) valueTuple)
        {
          ...
          return num5 != 0 ? num5 : comparer.Compare((object) this.Item6, (object) valueTuple.Item6);
        }
        ThrowHelper.ThrowArgumentException_TupleIncorrectType((object) this);
      }
      return 1;
...
label_24:
      return HashCode.Combine<int, int, int, int, int, int>(num1, num2, num3, num4, num5, num6);
    }
    ...
    private int GetHashCodeCore(IEqualityComparer comparer) => HashCode.Combine<int, int, int, int, int, int>(comparer.GetHashCode((object) this.Item1), comparer.GetHashCode((object) this.Item2), comparer.GetHashCode((object) this.Item3), comparer.GetHashCode((object) this.Item4), comparer.GetHashCode((object) this.Item5), comparer.GetHashCode((object) this.Item6));
