...
namespace System
{
    ...
    ITuple
  {
    ...
    private bool Equals([NotNullWhen(true)] object other, IEqualityComparer comparer) => other != null && other is Tuple<T1, T2> tuple && comparer.Equals((object) this.m_Item1, (object) tuple.m_Item1) && comparer.Equals((object) this.m_Item2, (object) tuple.m_Item2);
    ...
    private int GetHashCode(IEqualityComparer comparer) => Tuple.CombineHashCodes(comparer.GetHashCode((object) this.m_Item1), comparer.GetHashCode((object) this.m_Item2));
