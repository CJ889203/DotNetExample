...
namespace System
{
    ...
    ITuple
  {
    ...
    public override bool Equals([NotNullWhen(true)] object? obj) => obj is (T1, T2, T3) other && this.Equals(other);
    ...
    public bool Equals((T1, T2, T3) other) => EqualityComparer<T1>.Default.Equals(this.Item1, other.Item1) && EqualityComparer<T2>.Default.Equals(this.Item2, other.Item2) && EqualityComparer<T3>.Default.Equals(this.Item3, other.Item3);
    ...
    bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer) => other is (T1, T2, T3) valueTuple && comparer.Equals((object) this.Item1, (object) valueTuple.Item1) && comparer.Equals((object) this.Item2, (object) valueTuple.Item2) && comparer.Equals((object) this.Item3, (object) valueTuple.Item3);
    ...
    public int CompareTo((T1, T2, T3) other)
    {
      ...
      return num2 != 0 ? num2 : Comparer<T3>.Default.Compare(this.Item3, other.Item3);
    }
    ...
    int IStructuralComparable.CompareTo(object other, IComparer comparer)
    {
      if (other != null)
      {
        if (other is (T1, T2, T3) valueTuple)
        {
          ...
          return num2 != 0 ? num2 : comparer.Compare((object) this.Item3, (object) valueTuple.Item3);
        }
        ThrowHelper.ThrowArgumentException_TupleIncorrectType((object) this);
      }
      return 1;
...
label_12:
      return HashCode.Combine<int, int, int>(num1, num2, num3);
    }
    ...
    private int GetHashCodeCore(IEqualityComparer comparer) => HashCode.Combine<int, int, int>(comparer.GetHashCode((object) this.Item1), comparer.GetHashCode((object) this.Item2), comparer.GetHashCode((object) this.Item3));
