...
label_10:
    ...
    private static unsafe string CreateStringForSByteConstructor(byte* pb, int numBytes)
    {
      ...
      string sbyteConstructor = wideChar1 != 0 ? string.FastAllocateString(wideChar1) : throw new ArgumentException(SR.Arg_InvalidANSIString);
      int wideChar2;
      fixed (char* lpWideCharStr = &sbyteConstructor._firstChar)
        wideChar2 = Interop.Kernel32.MultiByteToWideChar(0U, 1U, pb, numBytes, lpWideCharStr, wideChar1);
      if (wideChar2 == 0)
        throw new ArgumentException(SR.Arg_InvalidANSIString);
      return sbyteConstructor;
    }
