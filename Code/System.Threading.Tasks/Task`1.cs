...
namespace System.Threading.Tasks
{
  ...
  public class Task<TResult> : Task
  {
      ...
      CancellationToken cancellationToken)
    {
      ...
      return millisecondsTimeout == 0U ? Task.FromException<TResult>((Exception) new TimeoutException()) : (Task<TResult>) new Task.CancellationPromise<TResult>((Task) this, millisecondsTimeout, cancellationToken);
    }
